...
function loginUsuario(){
    global $parametros, $conexion,$respuesta;
    $sql = 'SELECT * FROM `usuarios` WHERE email = "'.$parametros['email_usuario'].'" and contrasenya =  "'.$parametros['contrasenya'].'"';
    ...
    if (mysqli_num_rows($resultado) > 0 ){
        ...
        $respuesta['id_usuario'] = $fila['id_usuario'];
    } else {
        $respuesta['resultado'] = 'NO';
    }
}

//$respuesta['resultado'] = 'OK, '.$parametros['datos'];
